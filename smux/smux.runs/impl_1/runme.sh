...
HD_PWD='C:/Users/Alvin/Documents/LogicDesignLabMonday/smux/smux.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log smux.vdi -applog -m64 -messageDb vivado.pb -mode batch -source smux.tcl -notrace
