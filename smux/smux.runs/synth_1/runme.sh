...
HD_PWD='C:/Users/Alvin/Documents/LogicDesignLabMonday/smux/smux.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log smux.vds -m64 -mode batch -messageDb vivado.pb -notrace -source smux.tcl
