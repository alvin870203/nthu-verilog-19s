  ...
  case (state)
    STATE_NUM0_1: begin
      case (key_num)
        ...
        default: a1_next = a1;
      endcase
      dig1_next = a1; // if(key_num == 7'd10) dig3_next = `F_NULL; // if(dig3 != `F_NULL) dig2_next = a_next;
      a0_next = `F_NULL;
      b1_next = `F_NULL;
      b0_next = `F_NULL;
      dig3_next = `F_NULL;
    ...
    STATE_NUM1_1: begin
      ...
      a1_next = a1;
      a0_next = a0;
      dig1_next = b1; // if(key_num == 7'd10) dig3_next = `F_NULL; // if(dig3 != `F_NULL) dig2_next = a_next;
      b0_next = `F_NULL;
      dig3_next = `F_NULL;
      dig2_next = `F_NULL;
      dig0_next = `F_NULL;
