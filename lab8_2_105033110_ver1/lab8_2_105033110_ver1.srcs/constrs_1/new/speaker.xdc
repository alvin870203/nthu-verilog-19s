...
# DoReMi push button
set_property PACKAGE_PIN W19 [get_ports {Do_pb}]
set_property IOSTANDARD LVCMOS33 [get_ports {Do_pb}]
set_property PACKAGE_PIN U18 [get_ports {Re_pb}]
set_property IOSTANDARD LVCMOS33 [get_ports {Re_pb}]
set_property PACKAGE_PIN T17 [get_ports {Mi_pb}]
set_property IOSTANDARD LVCMOS33 [get_ports {Mi_pb}]
