...
`define SSD_ADD   `SSD_BIT_WIDTH'b0111_1111 // +
`define SSD_SUBTRACT   `SSD_BIT_WIDTH'b1111_1101 // -
`define SSD_MULTIPLY   `SSD_BIT_WIDTH'b1110_1111 // *
...
`define MINUS 4'd11; // BCD for SSD_SUBTRACT // -